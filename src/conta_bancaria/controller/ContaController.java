...
public class ContaController implements ContaRepository{
	...
	public void sacar(int numero, float valor) {
		...
		System.out.printf("\nO depósito no valor de %.2f, na conta numero: %d foi efetuado com sucesso!%n", valor, numero);
		}else {
	...
	public void transferir(int numeroOrigem, int numeroDestino, float valor) {
		...
		if(contaOrigem != null && contaDestino != null) {
			if(contaOrigem.sacar(valor) == true) {
				...
				System.out.println("/nA transferência no valor de %.2f, da conta número: %d para a conta: %d para a conta número: %d, foi efetuada com sucesso!%n");
			}
		} else {
			System.out.println("\nA conta de Origem e/ou de Destino não foram encontradas!%n");
		}
    ...
    public void listarPorTitular(String titular) {
        ...
        if(listaTitulares.isEmpty()) {
            System.out.printf("\nNenhuma conta foi encontrada para titulars que possuam o nome: %s", titular);
        }
